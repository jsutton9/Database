...
/**
 * This outputs the union of two specified tables.
 */
public class UnionCommand extends AbstractQueryCommand {
	private Pattern pattern = Pattern.compile(
			"union\\s+(?:([a-zA-Z]+|\\$\\d+)|\\(.*\\))\\s+and\\s+(?:([a-zA-Z]+|\\$\\d+)|\\(.*\\))\\s*;", Pattern.CASE_INSENSITIVE);
